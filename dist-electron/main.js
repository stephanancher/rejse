...
electron_1.app.whenReady().then(() => {
    ...
    electron_1.ipcMain.handle('save-to-excel', async (event, { filePath, date, description, km }) => {
        try {
            ...
            const targetPath = path_1.default.join(dir, targetFilename);
    ...
    electron_1.ipcMain.handle('save-image', async (event, { filePath, dataBase64 }) => {
        try {
    ...
    electron_1.ipcMain.handle('capture-map', async (event, { rect, filePath }) => {
        try {
